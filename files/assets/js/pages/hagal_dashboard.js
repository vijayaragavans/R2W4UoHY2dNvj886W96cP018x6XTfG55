/* [ ---- Hagal Admin - dashboard ---- ] */
    ...
    $(function() {
        ...
        //* tabs init
        $('#chTabs a').click(function (e) {
            e.preventDefault();
            $(this).tab('show');
            if($(this).attr('href') == '#ch_panel_users' && !$('#ch_users').children().length) {
                hagal_charts.pages();
            }
            if($(this).attr('href') == '#ch_panel_pages' && !$('#ch_pages').children().length) {
                hagal_charts.pages();
            }
            if($(this).attr('href') == '#ch_panel_sales' && !$('#ch_sales').children().length) {
                hagal_charts.sales();
            }
        })
